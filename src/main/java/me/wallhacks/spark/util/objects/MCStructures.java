...
public enum MCStructures {
    ...
    EndCity (new ResourceLocation("textures/icons/structures/endcity.png"), 5),
    Mansion (new ResourceLocation("textures/icons/structures/mansion.png"), 9),
    Mineshaft (new ResourceLocation("textures/icons/structures/mineshaft.png"), 5),
    Stronghold (new ResourceLocation("textures/icons/structures/stronghold.png"), 10),
