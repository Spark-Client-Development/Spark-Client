...
public class PacketFly extends Module {
    ...
    ModeSetting jitter = new ModeSetting("Jitter", this, "Adaptive", Arrays.asList("Adaptive", "Fixed"), v -> mode.is("Jitter"), "Jitter");
    IntSetting rate = new IntSetting("Rate", this, 10, 1, 200, v -> mode.is("Jitter"), "Jitter");
    DoubleSetting lowFactor = new DoubleSetting("LowFactor", this, 0.05D, -10.0D, 10.0D, v -> mode.is("Jitter"), "Jitter");
    DoubleSetting highFactor = new DoubleSetting("HighFactor", this, 0.5D, 0.0D, 10.0D, v -> mode.is("Jitter"), "Jitter");
    ...
    ModeSetting phase = new ModeSetting("Phase", this, "Stupid", Arrays.asList("Stupid", "Full", "None"), "Phase");
    DoubleSetting phaseSpeed = new DoubleSetting("Speed", this, 0.5D, 0.1D, 1D, "Phase");
