        ...
        if (!doingSomething && !args.hasAny()) {
            ...
            if (resetting) {
                ...
                logDirect(String.format(
                        ...
                        setting.getName(),
                        Boolean.toString((Boolean) setting.getValue())
                ));
            } else {
            ...
            if ((setting.getName().equals("chatControl") && !(Boolean) setting.getValue() && !Baritone.settings().chatControlAnyway.getValue()) ||
                    setting.getName().equals("chatControlAnyway") && !(Boolean) setting.getValue() && !Baritone.settings().chatControl.getValue()) {
