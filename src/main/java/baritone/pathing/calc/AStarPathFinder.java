...
public final class AStarPathFinder extends AbstractNodeCostSearch {
    ...
    protected Optional<IPath> calculate0(long primaryTimeout, long failureTimeout) {
        ...
        int pathingMaxChunkBorderFetch = Baritone.settings().pathingMaxChunkBorderFetch.getValue(); // grab all settings beforehand so that changing settings during pathing doesn't cause a crash or unpredictable behavior
