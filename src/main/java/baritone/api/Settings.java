...
public final class Settings {
     ...
     */
    public final Setting<Boolean> allowBreak = new Setting<>(true, "General");

    /**
     * Allow Baritone to sprint
     */
    public final Setting<Boolean> allowSprint = new Setting<>(true, "General");

    /**
     * Allow Baritone to place blocks
     */
    public final Setting<Boolean> allowPlace = new Setting<>(true, "General");

    /**
     * Allow Baritone to move items in your inventory to your hotbar
     */
    public final Setting<Boolean> allowInventory = new Setting<>(false, "General");
     ...
     */
    public final Setting<Boolean> assumeExternalAutoTool = new Setting<>(false, "Advanced");

    /**
     * If this setting is on, no auto tool will occur at all, not at calculation time nor execution time
     */
    public final Setting<Boolean> disableAutoTool = new Setting<>(false, "Advanced");
     ...
     */
    public final Setting<Boolean> allowWaterBucketFall = new Setting<>(true, "Advanced");

    /**
     * Allow Baritone to assume it can walk on still water just like any other block.
     * This functionality is assumed to be provided by a separate library that might have imported Baritone.
     */
    public final Setting<Boolean> assumeWalkOnWater = new Setting<>(false, "General");

    /**
     * If you have Fire Resistance and Jesus then I guess you could turn this on lol
     */
    public final Setting<Boolean> assumeWalkOnLava = new Setting<>(false, "General");

    /**
     * Assume step functionality; don't jump on an Ascend.
     */
    public final Setting<Boolean> assumeStep = new Setting<>(false, "General");
     ...
     */
    public final Setting<Boolean> assumeSafeWalk = new Setting<>(false, "Advanced");
     ...
     */
    public final Setting<Boolean> allowJumpAt256 = new Setting<>(false, "Movement");
     ...
     */
    public final Setting<Boolean> allowParkourAscend = new Setting<>(true, "Movement");
     ...
     */
    public final Setting<Boolean> allowDiagonalDescend = new Setting<>(false, "Movement");
     ...
     */
    public final Setting<Boolean> allowDiagonalAscend = new Setting<>(false, "Movement");
     ...
     */
    public final Setting<Boolean> allowDownward = new Setting<>(true, "Movement");
     ...
     */
    public final Setting<Boolean> buildIgnoreExisting = new Setting<>(false, "Schematica");
     ...
     */
    public final Setting<Boolean> avoidUpdatingFallingBlocks = new Setting<>(true, "Advanced");
     ...
     */
    public final Setting<Boolean> allowVines = new Setting<>(false, "Advanced");
     ...
     */
    public final Setting<Boolean> allowWalkOnBottomSlab = new Setting<>(true, "Advanced");
     ...
     */
    public final Setting<Boolean> allowParkour = new Setting<>(false, "Movement");
     ...
     */
    public final Setting<Boolean> allowParkourPlace = new Setting<>(false, "Movement");

    /**
     * For example, if you have Mining Fatigue or Haste, adjust the costs of breaking blocks accordingly.
     */
    public final Setting<Boolean> considerPotionEffects = new Setting<>(true, "Advanced");

    /**
     * Sprint and jump a block early on ascends wherever possible
     */
    public final Setting<Boolean> sprintAscends = new Setting<>(true, "Movement");
     ...
     */
    public final Setting<Boolean> overshootTraverse = new Setting<>(true, "Advanced");

    /**
     * When breaking blocks for a movement, wait until all falling blocks have settled before continuing
     */
    public final Setting<Boolean> pauseMiningForFallingBlocks = new Setting<>(true, "Advanced");
     ...
     */
    public final Setting<Boolean> avoidance = new Setting<>(false, "Avoidance");
     ...
     */
    public final Setting<Boolean> rightClickContainerOnArrival = new Setting<>(true, "Advanced");

    /**
     * When running a goto towards a nether portal block, walk all the way into the portal
     * instead of stopping one block before.
     */
    public final Setting<Boolean> enterPortal = new Setting<>(true, "Advanced");

    /**
     * Don't repropagate cost improvements below 0.01 ticks. They're all just floating point inaccuracies,
     * and there's no point.
     */
    public final Setting<Boolean> minimumImprovementRepropagation = new Setting<>(true, "PathFinding");
     ...
     */
    public final Setting<Boolean> cutoffAtLoadBoundary = new Setting<>(false, "PathFinding");
     ...
     */
    public final Setting<Float> pathingMapLoadFactor = new Setting<>(0.75f, "PathFinding");
     ...
     */
    public final Setting<Boolean> allowOvershootDiagonalDescend = new Setting<>(true, "Movement");
     ...
     */
    public final Setting<Boolean> simplifyUnloadedYCoord = new Setting<>(true, "PathFinding");

    /**
     * Whenever a block changes, repack the whole chunk that it's in
     */
    public final Setting<Boolean> repackOnAnyBlockChange = new Setting<>(true, "PathFinding");
     ...
     */
    public final Setting<Boolean> chunkCaching = new Setting<>(true, "Advanced");
     ...
     */
    public final Setting<Boolean> pruneRegionsFromRAM = new Setting<>(true, "Advanced");
     ...
     */
    public final Setting<Boolean> containerMemory = new Setting<>(false, "Advanced");

    /**
     * Fill in blocks behind you
     */
    public final Setting<Boolean> backfill = new Setting<>(false, "General");

    /**
     * Shows popup message in the upper right corner, similarly to when you make an advancement
     */
    public final Setting<Boolean> logAsToast = new Setting<>(false, "Debug");
     ...
     */
    public final Setting<Long> toastTimer = new Setting<>(5000L, "Debug");

    /**
     * Print all the debug messages to chat
     */
    public final Setting<Boolean> chatDebug = new Setting<>(false, "Debug");

    /**
     * Allow chat based control of Baritone. Most likely should be disabled when Baritone is imported for use in
     * something else
     */
    public final Setting<Boolean> chatControl = new Setting<>(true, "Advanced");

    /**
     * Some clients like Impact try to force chatControl to off, so here's a second setting to do it anyway
     */
    public final Setting<Boolean> chatControlAnyway = new Setting<>(false, "Advanced");

    /**
     * Render the path
     */
    public final Setting<Boolean> renderPath = new Setting<>(true, "Render");

    /**
     * Render the path as a line instead of a frickin thingy
     */
    public final Setting<Boolean> renderPathAsLine = new Setting<>(false, "Render");

    /**
     * Render the goal
     */
    public final Setting<Boolean> renderGoal = new Setting<>(true, "Render");

    /**
     * Render selection boxes
     */
    public final Setting<Boolean> renderSelectionBoxes = new Setting<>(true, "Render");

    /**
     * Ignore depth when rendering the goal
     */
    public final Setting<Boolean> renderGoalIgnoreDepth = new Setting<>(true, "Render");
     ...
     */
    public final Setting<Boolean> renderGoalXZBeacon = new Setting<>(false, "Render");

    /**
     * Ignore depth when rendering the selection boxes (to break, to place, to walk into)
     */
    public final Setting<Boolean> renderSelectionBoxesIgnoreDepth = new Setting<>(true, "Render");

    /**
     * Ignore depth when rendering the path
     */
    public final Setting<Boolean> renderPathIgnoreDepth = new Setting<>(true, "Render");
     ...
     * Improves FPS.
     */
    public final Setting<Boolean> fadePath = new Setting<>(false, "Render");

    /**
     * Move without having to force the client-sided rotations
     */
    public final Setting<Boolean> freeLook = new Setting<>(true, "General");
     ...
     */
    public final Setting<Boolean> antiCheatCompatibility = new Setting<>(true, "Advanced");
     ...
     * Never turn this on
     */
    public final Setting<Boolean> pathThroughCachedOnly = new Setting<>(false, "PathFinding");

    /**
     * Continue sprinting while in water
     */
    public final Setting<Boolean> sprintInWater = new Setting<>(true, "Advanced");
     ...
     */
    public final Setting<Boolean> blacklistClosestOnFailure = new Setting<>(true, "PathFinding");
     ...
     */
    public final Setting<Boolean> renderCachedChunks = new Setting<>(false, "Render");
     ...
     */
    public final Setting<Boolean> prefixControl = new Setting<>(true, "Advanced");

    /**
     * The command prefix for chat control
     */
    public final Setting<String> prefix = new Setting<>("#", "General");

    /**
     * Use a short Baritone prefix [B] instead of [Baritone] when logging to chat
     */
    public final Setting<Boolean> shortBaritonePrefix = new Setting<>(false, "Debug");

    /**
     * Echo commands to chat when they are run
     */
    public final Setting<Boolean> echoCommands = new Setting<>(true, "Debug");

    /**
     * Censor coordinates in goals and block positions
     */
    public final Setting<Boolean> censorCoordinates = new Setting<>(false, "Advanced");

    /**
     * Censor arguments to ran commands, to hide, for example, coordinates to #goal
     */
    public final Setting<Boolean> censorRanCommands = new Setting<>(false, "Advanced");

    /**
     * Stop using tools just before they are going to break.
     */
    public final Setting<Boolean> itemSaver = new Setting<>(false, "Advanced");
     ...
     */
    public final Setting<Boolean> preferSilkTouch = new Setting<>(false, "Advanced");

    /**
     * Don't stop walking forward when you need to break blocks in your way
     */
    public final Setting<Boolean> walkWhileBreaking = new Setting<>(true, "Advanced");
     ...
     */
    public final Setting<Boolean> splicePath = new Setting<>(true, "PathFinding");
    ...
    public class DoubleSetting extends Setting<Double> {
        ...
        public DoubleSetting(double value, double min, double max, String category) {
    ...
    public class IntSetting extends Setting<Integer> {
        ...
        public IntSetting(int value, int min, int max) {
            super(value);
            this.max = max;
            this.min = min;
        }

        public IntSetting(int value, int min, int max, String category) {
            super(value, category);
            this.max = max;
            this.min = min;
        }
    ...
    public class Setting<T> {
        ...
        @SuppressWarnings("unchecked")
        private Setting(T value, String category) {
            if (value == null) {
                throw new IllegalArgumentException("Cannot determine value type class from null");
            }
        ...
        /**
         * Deprecated! Please use .getValue() directly instead
         *
        ...
        public void setValue(T value) {
            this.value = value;
            BaritoneConfig.getInstance().sync(this);
        }
        ...
        public void toggle() {
            if (this.value instanceof Boolean) {
                ((Settings.Setting<Boolean>) this).value ^= true;
                BaritoneConfig.getInstance().sync(this);
            }
        }
    ...
    Settings() {
        ...
        try {
            for (Field field : temp) {
                if (field.getType().equals(Setting.class) || field.getType().equals(DoubleSetting.class) || field.getType().equals(IntSetting.class)) {
                    ...
                    if (field.getType().equals(Setting.class)) {
                        ...
                        tmpSettingTypes.put(setting, Double.class);
                    } else if (field.getType().equals(IntSetting.class)) {
                        tmpSettingTypes.put(setting, Integer.class);
                    }
                }
            }
        ...
        BaritoneConfig.getInstance().init(this);
    }
