...
public class GoalAxis implements Goal {
    ...
    public boolean isInGoal(int x, int y, int z) {
        return y == BaritoneAPI.getSettings().axisHeight.getValue() && (x == 0 || z == 0 || Math.abs(x) == Math.abs(z));
    }
    ...
    public double heuristic(int x0, int y, int z0) {
        ...
        return flatAxisDistance * BaritoneAPI.getSettings().costHeuristic.getValue() + GoalYLevel.calculate(BaritoneAPI.getSettings().axisHeight.getValue(), y);
    }
